...
#ifndef _H_EMBER_LIKE_OSB_MOTIF
#define _H_EMBER_LIKE_OSB_MOTIF
...
class EmberLikeOSUGenerator : public EmberMessagePassingGenerator {

public:
    SST_ELI_REGISTER_SUBCOMPONENT(
        EmberLikeOSUGenerator,
        "ember",
        "LikeOSUMotif",
...
public:
	EmberLikeOSUGenerator(SST::ComponentId_t, Params& params);
